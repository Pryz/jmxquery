...
public class JMXQuery {
	...
	public void ping() throws IOException {
		try {
			MBeanServerConnection testConnection = connector
	...
	public String searchDynamicMbean(String name) throws IOException {
		Set<ObjectName> mbeans = connection.queryNames(null, null);
		for(ObjectName mbname : mbeans){
			if(mbname.getCanonicalName().startsWith(name) == true) {
				return mbname.getCanonicalName();
			}
		}
		return null;
	}
